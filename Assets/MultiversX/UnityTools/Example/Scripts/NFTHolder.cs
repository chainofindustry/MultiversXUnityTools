...
namespace MultiversX.UnityTools.Examples
{
    ...
    public class NFTHolder : MonoBehaviour
    {
        ...
        public void SendNFT()
        {
            API.SendNFT(demoScript.nftDestination.text, collectionIdentifier, nonce, 1, CompleteListener);
        }
        ...
        private void CompleteListener(CompleteCallback<string[]> result)
        {
            ...
            {
                API.CheckTransactionStatus(result.data, BlockchainTransactionListener, 1);
