...
namespace MultiversX.UnityTools.Examples
{
    public class ConnectedScreen : GenericUIScreen
    {
        ...
        public override void Init(params object[] args)
        {
            ...
            API.RefreshAccount(AccountRefreshed);
            //load profile picture and cover photo from xPortal
            LoadProfileImages(API.GetConnectedAccount().Address.ToString());
        }
        ...
        private void LoadProfileImages(string address)
        {
            ...
            API.LoadImage($"https://id-api.multiversx.com/users/photos/profile/{address}", profilePicture, PictureLoadComplete);
            API.LoadImage($"https://id-api.multiversx.com/users/photos/cover/{address}", banner, CoverLoadComplete);
        }
